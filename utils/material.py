...
def set_principled_node(principled_node: bpy.types.Node,
    ...
    principled_node.inputs['Emission'].default_value = (0.0, 0.0, 0.0, 1.0)
...
def build_pbr_textured_nodes_nimble(node_tree: bpy.types.NodeTree,
                             color_texture_path: str = "",
                             metallic_texture_path: str = "",
                             roughness_texture_path: str = "",
                             normal_texture_path: str = "",
    ...
    # set_principled_node(principled_node=principled_node,
    #                     subsurface=0.064,
    #                     subsurface_color=(0.8, 0.43, 0.411, 1.0),
    #                     roughness=1)
    ...
    if normal_texture_path != "":
        ...
        normal_map_node.inputs['Strength'].default_value = 1.5
    ...
    if specular_texture_path != "":
        texture_node = create_texture_node(node_tree, specular_texture_path, False)
        node_tree.links.new(mapping_node.outputs['Vector'], texture_node.inputs['Vector'])
        node_tree.links.new(texture_node.outputs['Color'], principled_node.inputs['Specular'])
    ...
    # set_principled_node(principled_node=principled_node, base_color=(0.8, 0.05, 0.7, 1.0))
