...
import random
import torchvision
import VAEPose.VaePose.utils.func as func
from VAEPose.VaePose.config.rhd_config import SNAP_BONES, JOINT_COLORS
...
def batch_with_joint(clrs, uvds):
    ...
    for i in range(16):
        ...
        clr = draw_hand_skeloten(clr, uv, SNAP_BONES)
        batch.append(clr)
...
def draw_hand_skeloten(clr, uv, bone_links, colors=JOINT_COLORS):
