...
from VaePose.common.utils.preprocessing import load_img, process_bbox, augmentation, get_bbox
from VaePose.common.utils.transforms import align_w_scale
from VaePose.common.utils.mano import MANO
...
class DEX_YCB_SF(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, transform, data_split):
        ...
        self.root_dir = "/mnt/sdc/zhuoran/dexycb"
