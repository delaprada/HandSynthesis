...
from VaePose.common.utils.manopth.manopth.manolayer import ManoLayer
...
class MANO(object):
    ...
    def get_layer(self):
        return ManoLayer(mano_root="/mnt/sdc/zhuoran/proj/HandRecon/manopth/mano/models", flat_hand_mean=False, use_pca=False)  # load right hand MANO model
